...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ahmedabad-event-hub-default-secret-key-2026')
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'EventSphere <noreply@eventsphere.com>')
